    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    body = useFormData
                        ? (0, utils_1.createQueryParams)(options)
                        : JSON.stringify(options);
                    return [4 /*yield*/, (0, http_1.getJSON)("".concat(baseUrl, "/oauth/token"), timeout, audience || 'default', scope, {
                            method: 'POST',
                            body: body,
                            headers: {
                                'Content-Type': useFormData
                                    ...
                                    : 'application/json',
                                'X-SlashAuth-Client': btoa(JSON.stringify(auth0Client || constants_1.DEFAULT_SLASHAUTH_CLIENT)),
                            },
                        }, worker, useFormData)];
