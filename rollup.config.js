...
const EXPORT_NAME = 'createSlashAuthClient';
...
const footer = `('SlashAuthClient' in this) && this.console && this.console.warn && this.console.warn('SlashAuthClient already declared on the global namespace');
this && this.${EXPORT_NAME} && (this.SlashAuthClient = this.SlashAuthClient || this.${EXPORT_NAME}.SlashAuthClient);`;
...
let bundles = [
  {
    ...
    output: {
      name: EXPORT_NAME,
      file: 'dist/slashauth-client-js.development.js',
      footer,
      format: 'umd',
      sourcemap: true,
    },
  ...
  bundles = bundles.concat(
    {
      ...
      output: [
        {
          name: EXPORT_NAME,
          file: 'dist/slashauth-client-js.production.js',
          footer,
          format: 'umd',
        },
      ],
